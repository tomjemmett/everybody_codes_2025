...
import ECSolution
import Events.Y2024.Quest01 (quest01)
import Events.Y2024.Quest02 (quest02)
import Events.Y2024.Quest03 (quest03)
import Events.Y2024.Quest04 (quest04)
import Events.Y2024.Quest05 (quest05)
import Events.Y2024.Quest06 (quest06)
import Events.Y2024.Quest07 (quest07)
import Events.Y2024.Quest08 (quest08)
import Events.Y2024.Quest09 (quest09)
import Events.Y2024.Quest10 (quest10)
import Events.Y2024.Quest11 (quest11)
import Events.Y2024.Quest12 (quest12)
import Events.Y2024.Quest13 (quest13)
import Events.Y2024.Quest14 (quest14)
import Events.Y2024.Quest15 (quest15)
import Events.Y2024.Quest16 (quest16)
import Events.Y2024.Quest17 (quest17)
import Events.Y2024.Quest18 (quest18)
import Events.Y2024.Quest19 (quest19)
import Events.Y2024.Quest20 (quest20)
...
runQuest quest = do
  ...
  contents <- readFile (createPath "sample" 2024 quest 1)
...
tryAnswer quest part = do
  ...
  when response do
    submitAnswer 2024 quest part actualAnswer
    when (part < 3) $ downloadNotes 2024 quest
