...
import Stories.S1.Quest01 (quest01)
import Stories.S1.Quest02 (quest02)
import Stories.S1.Quest03 (quest03)
...
runQuest quest = do
  ...
  contents <- readFile (createPath "sample" 1 quest 1)
...
tryAnswer quest part = do
  ...
  when response do
    submitAnswer 1 quest part actualAnswer
    when (part < 3) $ downloadNotes 1 quest
