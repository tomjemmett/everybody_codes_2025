...
import Stories.S2.Quest01 (quest01)
import Stories.S2.Quest02 (quest02)
import Stories.S2.Quest03 (quest03)
...
runQuest quest = do
  ...
  contents <- readFile (createPath "sample" 2 quest 1)
...
tryAnswer quest part = do
  ...
  when response do
    submitAnswer 2 quest part actualAnswer
    when (part < 3) $ downloadNotes 2 quest
